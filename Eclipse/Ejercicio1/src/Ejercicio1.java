...
public class Ejercicio1 {
  ...
  static final String BASE_DIRECTORY_WINDOWS = "C:\\DAM\\accesodatos\\Ejercicio1\\";
  static final String BASE_DIRECTORY_LINUX = "/home/deck/DAM/accesodatos/Ejercicio1/";
  ...
  public static void createFile(String fileName) {
    File file = new File(BASE_DIRECTORY_LINUX + fileName);
    if (!file.exists()) {
      try {
  ...
  public static void main(String[] args) {
    ...
    File fullDirectory = new File(BASE_DIRECTORY_LINUX + directoryName);
